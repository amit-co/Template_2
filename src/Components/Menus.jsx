        ...
        <>
            <div className="flex flex-col  items-center mb-10">
                ...
                <div className="flex flex-col sm:flex-row items-center mx-10 xl:space-x-10 space-y-4 sm:space-y-0">
                    <div className="flex flex-col w-full sm:w-full  sm:ml-0 mt-10 sm:mt-0">
                        ...
                        <p className="hidden sm:block text-lg lg:text-2xl text-center font-medium text-gray-900    ">
                    ...
                    <div className="flex w-full sm:w-full sm:ml-0">
                        <img src={img10} />
                    </div>
                </div>
            </div>
